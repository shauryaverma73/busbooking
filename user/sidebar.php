	...
	<body>
		<div class="sidebar-container">
			...
			<ul class="sidebar-navigation">
				...
				<li>
					<a href="../user/timings.php">
						<i class="fa fa-tachometer" aria-hidden="true"></i>View Timings
					</a>
				</li>
				<li>
					<a href="../user/booking.php">
						<i class="fa fa-tachometer" aria-hidden="true"></i> Book Tickets
					</a>
				</li>	
				<li>
					<a href="../user/my_bookings.php">
						<i class="fa fa-tachometer" aria-hidden="true"></i> My Bookings
					</a>
				</li>
				<li>
